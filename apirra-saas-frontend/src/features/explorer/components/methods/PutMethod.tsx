...
const PutMethod: React.FC<PutMethodProps> = ({
  endpoint,
  onExecute,
  loading,
  baseUrl,
    ...
    <div className="mx-auto w-full max-w-auto space-y-6 p-4">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1 space-y-2 min-w-0">
            <div className="flex items-center gap-3 min-w-0">
              <span className="method-pill method-pill-put rounded-lg px-3 py-1 text-xs tracking-widest">
                PUT
              </span>
      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6">
        ...
        <textarea
          ...
          className="min-h-[320px] w-full resize-y overflow-auto rounded-lg border border-white/10 bg-white/5 p-4 font-mono text-sm text-white transition-all placeholder:text-slate-500 focus:border-amber-400 focus:ring-2 focus:ring-amber-500/20 disabled:opacity-60"
      ...
      <div className="space-y-4 rounded-xl border border-white/10 bg-white/[0.03] p-6">
        <div className="flex flex-col gap-3 sm:flex-row">
          <button
            ...
            className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-amber-600 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-amber-500/20 transition hover:bg-amber-500 disabled:opacity-60 sm:flex-none"
