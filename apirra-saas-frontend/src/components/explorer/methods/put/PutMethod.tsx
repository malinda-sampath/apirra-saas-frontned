      ...
      <div className="space-y-4 rounded-xl border border-gray-200 bg-white p-6">
        <div className="flex flex-col gap-3 sm:flex-row">
          <button
            ...
            className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-yellow-600 px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-yellow-700 disabled:opacity-60 sm:flex-none"
